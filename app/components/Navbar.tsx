...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-black text-white px-6 py-4 flex items-center justify-between">
      <Link
        to="/"
      ...
      <div className="flex gap-10 items-center text-sm font-mono uppercase">
