...
const events: Event[] = [
  ...
  },
  {
    ...
    poster: "/p5.jpg",
    description:
      "Learn & play Shogi — the Japanese chess game of strategy & focus.",
    rules: [
  ...
  },
  {
    ...
    poster: "/p6.jpg",
    description:
      "Decorate carp streamers and fill the sky with your wishes & colors.",
    rules: [
  ...
  },
  {
    ...
    poster: "/p7.jpg",
    description:
      "Face your fears in a spooky walk-through inspired by Japanese ghost legends!",
    rules: [
      ...
      <div className="flex justify-between items-center p-4 border-t border-black space-x-2">
        ...
        <div className="flex gap-2 items-center">
          ...
          <Link
            ...
            className="flex items-center px-3 py-1 border border-[#dc2626] rounded-full text-sm font-semibold transition-colors hover:bg-red-600 hover:text-white"
          >
            Register
          </Link>
        </div>
